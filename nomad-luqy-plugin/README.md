...
NOMAD plugin for parsing and analyzing LuQY data.
...
```sh
git clone https://github.com/QYBBelonovskii/nomad-luqy-plugin.git
cd nomad-luqy-plugin
...
| Name | E-mail     |
|------|------------|
| Aleksei Belonovskii | [belonovskii@qyb.berlin](mailto:belonovskii@qyb.berlin)
